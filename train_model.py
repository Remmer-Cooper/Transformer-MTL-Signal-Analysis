...
from utils.mltools1 import plot_confusion_matrix, calculate_confusion_matrix, plot_snr_confusion_matrix
...
torch.save(model.state_dict(), 'weights/mtl_model.pth')
...
plt.tight_layout()
plt.savefig('figure/accuracy_loss_curves.png')
plt.show()
