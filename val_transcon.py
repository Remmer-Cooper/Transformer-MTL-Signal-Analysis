...
from utils.mltools1_3 import plot_confusion_matrix, calculate_confusion_matrix, plot_snr_confusion_matrix
...
model.load_state_dict(torch.load(r'D:\Test\mywork\Muti_task_classify\weights\mtl_model_tracon.pth', weights_only=True))
model.eval()
...
plot_confusion_matrix(Y_mod_test.cpu().numpy(), mod_preds, 
                     ...
                     save_filename='figure/test_test_mod_confusion_trancon.png')

plot_confusion_matrix(Y_sig_test.cpu().numpy(), sig_preds,
                     title="Signal Confusion Matrix",
                     classes=sig_encoder.classes_,
                     save_filename='figure/test_test_sig_confusion_trancon.png')
...
plot_snr_confusion_matrix(
    ...
    save_dir='figure/modulation_trancon'
)
...
plot_snr_confusion_matrix(
    ...
    save_dir='figure/signal_trancon'
)